    ...
    return (
      ...
      ((metrics.demographic_parity &&
        ...
        (metrics.equal_opportunity &&
          Object.keys(metrics.equal_opportunity).length > 0) ||
        (metrics.disparate_impact &&
          Object.keys(metrics.disparate_impact).length > 0) ||
        (metrics.statistical_parity &&
          Object.keys(metrics.statistical_parity).length > 0) ||
        (metrics.equalized_odds &&
          Object.keys(metrics.equalized_odds).length > 0) ||
        (metrics.treatment_equality &&
          Object.keys(metrics.treatment_equality).length > 0))
    );
  };
            ...
            {!selectedModel && !loadingFairness && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
                ...
                <p className="text-blue-700">
                  Please select a model from the dropdown above to view its
                  fairness analysis.
                </p>
              </div>
            )}
              ...
              fairnessAPIData.metrics && (
                <>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                      <div className="text-center p-4 bg-gray-50 border border-gray-200 rounded-lg">
                        <div className="text-2xl font-bold text-gray-900">
                          {
                            fairnessAPIData.metrics.overall_assessment
                              .features_analyzed
                          }
                        </div>
                    ...
                    {fairnessAPIData.metrics.overall_assessment
                      .problematic_features.length > 0 && (
                      <div className="mb-6">
                        <h3 className="font-medium text-gray-900 mb-2">
                          Problematic Features
                        </h3>
                        <div className="flex flex-wrap gap-2">
                          {fairnessAPIData.metrics.overall_assessment.problematic_features.map(
                            (feature: string, index: number) => (
                              <span
                                key={index}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                          <div className="text-2xl font-bold text-green-900">
                            {(
                              fairnessAPIData.metrics.enhanced_analysis
                                .temporal_stability.stability_score * 100
                            ).toFixed(1)}
                            %
                          </div>
                          ...
                          <div className="text-xs text-green-600 mt-1">
                            ...
                            {
                              fairnessAPIData.metrics.enhanced_analysis
                                .temporal_stability.validation_test_consistency
                            }
                          </div>
                        </div>
                        ...
                        <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                          ...
                          <div className="text-xs text-purple-600 mt-1">
                            Features:{" "}
                            {fairnessAPIData.metrics.enhanced_analysis.intersectional_fairness.features_analyzed.join(
                              ", "
                            )}
                          </div>
                        </div>
                        ...
                        <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                          <div className="text-2xl font-bold text-orange-900">
                            {
                              fairnessAPIData.metrics.overall_assessment
                                .datasets_available.total_datasets
                            }
                          </div>
                  ...
                  {fairnessAPIData.metrics.enhanced_analysis
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                      ...
                      <div className="space-y-4">
                        {Object.entries(
                          fairnessAPIData.metrics.enhanced_analysis
                            .advanced_bias_detection.significance_tests
                        ).map(([feature, testResults]: [string, any]) => (
                          <div
                            key={feature}
                          ...
                          >
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <div className="flex items-center space-x-2">
                                <span
                                  className={`px-3 py-1 rounded-full text-sm font-medium ${
                                    testResults.violation_rate > 0.7
                                      ? "bg-red-100 text-red-800"
                                      : testResults.violation_rate > 0.3
                                      ? "bg-yellow-100 text-yellow-800"
                                      : "bg-green-100 text-green-800"
                                  }`}
                                >
                                  {(testResults.violation_rate * 100).toFixed(
                                    0
                                  )}
                                  % Violation Rate
                                </span>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm mb-4">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {testResults.total_groups_tested}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">
                                ...
                                <span className="font-medium text-red-600">
                                  {testResults.significant_violations.length}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">
                            ...
                            {testResults.significant_violations.length > 0 && (
                              <div>
                                <h4 className="text-sm font-medium text-gray-700 mb-2">
                                  Significant Violations Details:
                                </h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                  {testResults.significant_violations
                                    .slice(0, 6)
                                    .map((violation: any, index: number) => (
                                      <div
                                        key={index}
                                        className="text-xs bg-red-50 text-red-700 p-2 rounded border border-red-200"
                                      >
                                        ...
                                        <div className="text-xs text-red-600">
                                          p-value:{" "}
                                          {violation.p_value.toExponential(2)} |
                                          χ²:{" "}
                                          {violation.chi2_statistic.toFixed(2)}{" "}
                  ...
                  {fairnessAPIData.metrics.enhanced_analysis
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                      ...
                      {fairnessAPIData.metrics.enhanced_analysis
                        .cross_dataset_comparison.consistency_analysis && (
                        <div className="mb-6">
                          <h3 className="text-lg font-medium text-gray-900 mb-4">
                            Validation vs Test Dataset Consistency
                          </h3>
                          <div className="space-y-4">
                            {Object.entries(
                              fairnessAPIData.metrics.enhanced_analysis
                                .cross_dataset_comparison.consistency_analysis
                            ).map(([feature, groups]: [string, any]) => (
                              <div
                                key={feature}
                                className="border border-gray-200 rounded-lg p-4"
                              >
                                      ...
                                      >
                                        ...
                                        <div className="space-y-1 text-xs">
                                          <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">
                                              {(
                                                data.validation_selection_rate *
                                                100
                                              ).toFixed(1)}
                                              %
                                            </span>
                                          ...
                                          <div className="flex justify-between">
                                            ...
                                            <span
                                              className={`font-medium ${
                                                data.absolute_difference > 0.05
                                                  ? "text-red-600"
                                                  : "text-green-600"
                                              }`}
                                            >
                                              {(
                                                data.absolute_difference * 100
                                              ).toFixed(1)}
                                              %
                                            </span>
                                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {fairnessAPIData.metrics.enhanced_analysis
                          .cross_dataset_comparison.validation_fairness && (
                          <div className="border border-gray-200 rounded-lg p-4">
                            <h4 className="font-medium text-gray-900 mb-3">
                              Validation Dataset Fairness
                            </h4>
                            {Object.entries(
                              fairnessAPIData.metrics.enhanced_analysis
                                .cross_dataset_comparison.validation_fairness
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {
                                  fairnessAPIData.metrics.enhanced_analysis
                                    .intersectional_fairness.features_analyzed
                                    .length
                                }
                              </span>
                            </div>
                            ...
                            <div className="mt-4">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {fairnessAPIData.metrics.enhanced_analysis.intersectional_fairness.features_analyzed.map(
                                  (feature: string, index: number) => (
                                    <span
                                      key={index}
                        ...
                        <div className="col-span-2">
                          ...
                          {fairnessAPIData.metrics.enhanced_analysis
                            .intersectional_fairness.group_metrics?.error ? (
                              ...
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-yellow-700 mt-1">
                                    {
                                      fairnessAPIData.metrics.enhanced_analysis
                                        .intersectional_fairness.group_metrics
                                        .error
                                    }
                                  </p>
                                </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                              <p className="text-gray-600 text-sm">
                                Intersectional analysis examines fairness across
                                combinations of sensitive attributes (e.g.,
                                gender × age interactions) to detect compound
                                biases that might not be visible when examining
                                individual attributes separately.
                              </p>
                              {fairnessAPIData.metrics.enhanced_analysis
                                .intersectional_fairness
                                .total_intersectional_groups > 1 && (
                                <div className="mt-3 p-3 bg-white rounded border">
                                  <div className="text-sm font-medium text-gray-900">
                                    ...
                                    intersectional groups identified
                                  </div>
                                  <div className="text-xs text-gray-600 mt-1">
                                    Analysis covers interactions between{" "}
                                    {fairnessAPIData.metrics.enhanced_analysis.intersectional_fairness.features_analyzed.join(
                                      " and "
                                    )}
                                  </div>
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {
                                    Object.keys(metrics.equal_opportunity || {})
                                      .length
                                  }
                                </span>
                              </div>
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {
                                    Object.keys(metrics.disparate_impact || {})
                                      .length
                                  }
                                </span>
                              </div>
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {
                                    Object.keys(metrics.statistical_tests || {})
                                      .length
                                  }
                                </span>
                              </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                    ...
                    <div className="space-y-6">
                      {Object.entries(fairnessAPIData.metrics.metrics)
                        .slice(0, 3)
                        .map(([feature, metrics]: [string, any]) => (
                          <div
                            key={feature}
                                ...
                                <div className="mb-4">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                                    {Object.entries(
                                      ...
                                      <div
                                        key={group}
                                        className="bg-green-50 p-2 rounded text-xs border border-green-200"
                                      >
                            ...
                            {metrics.statistical_tests &&
                              Object.keys(metrics.statistical_tests).length >
                                ...
                                <div className="mb-4">
                                  ...
                                  <div className="space-y-2">
                                    {Object.entries(metrics.statistical_tests)
                                      .slice(0, 3)
                                      .map(([group, test]: [string, any]) => (
                                        <div
                                          key={group}
                      ...
                      {Object.keys(fairnessAPIData.metrics.metrics).length >
                        3 && (
                        <div className="text-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                          <p className="text-gray-600">
                            📊 Showing detailed analysis for 3 features. Total
                            of{" "}
                            {
                              Object.keys(fairnessAPIData.metrics.metrics)
                                .length
                            }{" "}
                            features analyzed.
                          </p>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            Comprehensive fairness analysis including advanced
                            bias detection, cross-dataset comparison, and
              ...
              !fairnessAPIData.metrics && (
                <div className="bg-orange-100 border border-orange-300 rounded-lg p-4">
                  ...
                  <p className="text-orange-700 text-sm">
                    The API returned data, but it doesn't have the expected
                    'metrics' property structure.
                  </p>
                </div>
              )}
          </motion.div>
