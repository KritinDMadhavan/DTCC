...
const ProjectOverviewPage: React.FC = () => {
  ...
  const handleContactSupport = () => {
    ...
    window.location.href =
      "mailto:support@aigovdashboard.com?subject=Resource%20Limit%20Exceeded&body=Project%20ID:%20" +
      id;
  };
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      ...
      handleModelProcessingStart as EventListener
    );
    window.addEventListener(
      "modelProcessingSuccess",
      handleModelProcessingSuccess as EventListener
    );
    window.addEventListener(
      "modelProcessingError",
      handleModelProcessingError as EventListener
    );
  ...
  const fetchProjectData = async () => {
    ...
    try {
      ...
      setError(
        "Model exceeds free plan limits due to high compute requirements. Please upload a simplified version or contact our team to upgrade"
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-bold text-gray-900 mb-4">
          Benefits of Testing Your Model
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600">
              Track accuracy, precision, recall, F1 score, and AUC-ROC across
              different thresholds and data segments.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p className="text-gray-600 mb-4">
              A comprehensive performance analysis helps you understand how well
              your model works across different scenarios and data
              distributions.
            </p>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">
              Fairness and Explainability Benefits
            </h3>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Identify and mitigate bias across different demographic
                    groups to ensure fair outcomes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Understand how your model makes decisions with feature
                    importance and local explanations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Meet growing requirements for AI governance and
    ...
    <div className="p-8 space-y-8">
            ...
            <span
              className={`ml-4 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                project.project_status === "Completed"
                  ...
                  : project.project_status === "Running Test"
      ...
      {showProcessingAnimation && (
        <div className="mb-8 w-full">
          <div
            className={`w-full bg-white rounded-xl border shadow-md overflow-hidden ${
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-500">
                    Model: {processingModel.name}
                  </div>
                  <div className="text-sm text-gray-400">
                    Version: {processingModel.version}
                  </div>
                </div>
              </div>
              ...
              {processingModel.status === "success" && (
                <div className="mt-4 p-3 bg-green-50 rounded">
                  <p className="text-sm text-green-700">
                    Model processing completed successfully. The results are
                    ready to view.
                  </p>
                </div>
              )}
        ...
        <div className="bg-white rounded-lg border border-gray-200 my-6">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {metrics.explainability.feature_importance}%
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Local Fidelity</span>
                  <span className="font-medium">
                    {metrics.explainability.local_fidelity}%
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Global Fidelity</span>
                  <span className="font-medium">
                    {metrics.explainability.global_fidelity}%
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 border-b border-gray-100">
            <div className="p-6 border-r border-gray-100">
              ...
              <div className="space-y-4">
                {Object.entries(metrics.technical)
                  .slice(0, 4)
                  .map(([key, value]) => (
                    <div
                      key={key}
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                {Object.entries(metrics.training)
                  .slice(0, 4)
                  .map(([key, value]) => (
                    <div
                      key={key}
