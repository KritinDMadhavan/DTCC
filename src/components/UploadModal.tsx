...
const UploadModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (formData.dataset) {
        console.log("Step 2: Uploading training dataset file...");
        ...
        if (!datasetResponse.ok) {
          throw new Error(
            `Error uploading training dataset: ${datasetResponse.statusText}`
          );
        }

        const datasetData = await datasetResponse.json();
        console.log("Training dataset upload successful:", datasetData);
      ...
      } else if (formData.use_synthetic_validation) {
                  ...
                  <div className="space-y-8">
                    ...
                    {(formData.model_stage === "in_training" || formData.model_stage === "post_training" || formData.model_stage === "experimental") && (
                      <div className="space-y-6">
                        ...
                        {/* Synthetic Validation Data Option */}
                        {!formData.validation_dataset && (
                          <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl border border-purple-200">
                            <div className="flex items-center mb-4">
                              ...
                              <div className="ml-4">
                                <h6 className="text-lg font-medium text-purple-800">
                                  Generate Synthetic Validation Data
                                </h6>
                                <p className="text-purple-700 text-sm">
                                  No validation dataset? We can generate synthetic data based on your training data
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center mb-4">
                              <input
                                type="checkbox"
                                id="use_synthetic_validation"
                                checked={formData.use_synthetic_validation}
                                onChange={(e) =>
                                  setFormData({
                                    ...formData,
                                    use_synthetic_validation: e.target.checked,
                                  })
                                }
                                className="h-5 w-5 text-purple-600 border-purple-300 rounded focus:ring-purple-500"
                              />
                              <label
                                htmlFor="use_synthetic_validation"
                                className="ml-3 text-purple-800 font-medium"
                              >
                                Generate synthetic validation data from training data
                              </label>
                            </div>

                            {/* Synthetic Data Parameters */}
                            {formData.use_synthetic_validation && (
                              <div className="mt-6 space-y-6 bg-white p-6 rounded-xl border border-purple-100">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      ...
                                      <div className="relative ml-2 inline-block group">
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          Number of synthetic validation samples to generate
                                        </div>
                                      </div>
                                    </label>
                                    <input
                                      ...
                                      value={formData.synthetic_validation_params.sample_size}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                            ...formData.synthetic_validation_params,
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      Noise Level ({(formData.synthetic_validation_params.noise_level * 100).toFixed(1)}%)
                                      <div className="relative ml-2 inline-block group">
                                        <svg
                                          className="h-4 w-4 text-gray-400"
                                          fill="none"
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          Amount of random noise to add (0-50%)
                                        </div>
                                      </div>
                                    </label>
                                    <input
                                      ...
                                      value={formData.synthetic_validation_params.noise_level}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      ...
                                      <div className="relative ml-2 inline-block group">
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          Statistical distribution for synthetic data generation
                                        </div>
                                      </div>
                                    </label>
                                    <select
                                      className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 appearance-none bg-white"
                                      value={formData.synthetic_validation_params.distribution_type}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      Correlation Strength ({(formData.synthetic_validation_params.correlation_strength * 100).toFixed(1)}%)
                                      <div className="relative ml-2 inline-block group">
                                        <svg
                                          className="h-4 w-4 text-gray-400"
                                          fill="none"
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          How closely synthetic data correlates with training patterns
                                        </div>
                                      </div>
                                    </label>
                                    <input
                                      ...
                                      step="0.01"
                                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider"
                                      value={formData.synthetic_validation_params.correlation_strength}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                            ...formData.synthetic_validation_params,
                                            correlation_strength: parseFloat(e.target.value),
                                          },
                                        })
                                      }
                                    />
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      Outlier Percentage ({(formData.synthetic_validation_params.outlier_percentage * 100).toFixed(1)}%)
                                      <div className="relative ml-2 inline-block group">
                                        <svg
                                          className="h-4 w-4 text-gray-400"
                                          fill="none"
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          Percentage of outlier data points to include
                                        </div>
                                      </div>
                                    </label>
                                    <input
                                      ...
                                      step="0.01"
                                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider"
                                      value={formData.synthetic_validation_params.outlier_percentage}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                            ...formData.synthetic_validation_params,
                                            outlier_percentage: parseFloat(e.target.value),
                                          },
                                        })
                                      }
                                    />
                                  ...
                                  <div>
                                    <label className="block font-medium mb-2 text-gray-700">
                                      Feature Variance ({formData.synthetic_validation_params.feature_variance.toFixed(1)})
                                      <div className="relative ml-2 inline-block group">
                                        <svg
                                          className="h-4 w-4 text-gray-400"
                                          fill="none"
                                        ...
                                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-xs rounded-lg py-2 px-3 hidden group-hover:block z-10">
                                          Variance multiplier for feature generation
                                        </div>
                                      </div>
                                    </label>
                                    <input
                                      ...
                                      step="0.1"
                                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider"
                                      value={formData.synthetic_validation_params.feature_variance}
                                      onChange={(e) =>
                                        setFormData({
                                          ...formData,
                                          synthetic_validation_params: {
                                            ...formData.synthetic_validation_params,
                                            feature_variance: parseFloat(e.target.value),
                                          },
                                        })
                                      }
                                    />
                                  ...
                                  <div className="flex items-start">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-purple-700 text-sm mt-1">
                                        We'll generate <strong>{formData.synthetic_validation_params.sample_size}</strong> validation samples using{" "}
                                        <strong>{formData.synthetic_validation_params.distribution_type}</strong> distribution with{" "}
                                        <strong>{(formData.synthetic_validation_params.noise_level * 100).toFixed(1)}%</strong> noise level.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Select the type that best describes your training dataset
                      </p>
                    </div>

                    {/* Target Column Selection - only show after dataset is uploaded and analyzed */}
                    {formData.dataset && datasetColumns.length > 0 && (
                      <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
                        <label className="block font-medium mb-2 text-gray-700 flex items-center">
                          Target Column <span className="text-red-500 ml-1">*</span>
                          <div className="relative ml-2 group">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4 text-gray-400"
                        ...
                        {datasetColumns.length <= 10 ? (
                          // Show dropdown for 10 or fewer columns
                          <select
                            className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all appearance-none bg-white"
                          ...
                          // Show text input for more than 10 columns
                          <div>
                            <input
                              type="text"
                    ...
                    {formData.dataset && isAnalyzingDataset && (
                    ...
                    {formData.dataset && datasetAnalysisError && (
                      <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                        <p className="text-red-700 text-sm">
                          <strong>Dataset Analysis Error:</strong> {datasetAnalysisError}
                        </p>
                        <p className="text-red-600 text-xs mt-1">
                          Please ensure your file is a valid CSV or JSON format.
                        </p>
                      </div>
                    )}

                    {/* Validation Dataset Target Column Selection */}
                    {formData.validation_dataset && validationDatasetColumns.length > 0 && (
                      <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
                        <label className="block font-medium mb-2 text-gray-700 flex items-center">
                          ...
                          <div className="relative ml-2 group">
                            ...
                            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-48 bg-gray-800 text-white text-xs rounded py-1 px-2 hidden group-hover:block">
                              Target column in validation dataset (usually same as training)
                            </div>
                          </div>
                        </label>
                        <p className="text-sm text-gray-500 mb-3">
                          Found {validationDatasetColumns.length} columns in validation dataset
                        </p>
                        ...
                        {validationDatasetColumns.length <= 10 ? (
                          <select
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                validation_target_column: e.target.value,
                              })
                            }
                          >
                            <option value="">
                              Select validation target column (optional)
                            </option>
                            {validationDatasetColumns.map((column, index) => (
                              <option key={index} value={column}>
                                {column}
                              </option>
                            ))}
                          ...
                          <div>
                            <input
                              type="text"
                              placeholder="Type the exact validation target column name"
                              className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                              value={formData.validation_target_column}
                              onChange={(e) =>
                                setFormData({
                                ...
                                {validationDatasetColumns.map((column, index) => (
                                  <span
                                    ...
                                    onClick={() =>
                                      setFormData({
                                        ...formData,
                                        validation_target_column: column,
                                      })
                                    }
                                  >
                                    {column}
                    ...
                    {formData.validation_dataset && isAnalyzingValidationDataset && (
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 flex items-center">
                        <svg className="animate-spin h-5 w-5 mr-3 text-blue-600" viewBox="0 0 24 24">
                          <circle
                            className="opacity-25"
                    ...
                    {formData.validation_dataset && validationAnalysisError && (
                      <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                        <p className="text-red-700 text-sm">
                          <strong>Validation Dataset Analysis Error:</strong> {validationAnalysisError}
                        </p>
                        <p className="text-red-600 text-xs mt-1">
                          Please ensure your validation file is a valid CSV or JSON format.
                        </p>
                      </div>
                    )}
                  </div>
